...
//	qRegisterMetaType<pjsua_buddy_id>("pjsua_buddy_id");
	...
	/* HTTP Requests */
//    xcapPut = new QNetworkReply(this); /* will be deleted automatically with parent */
//    xcapGet = new QNetworkReply(this);
...
//    connect(xcapGet, SIGNAL(responseHeaderReceived(const QnetworkReply &)),
//            this, SLOT(xcapGetReadResponseHeader(const QnetworkReply &)));
...
void QjSimple::xcapGetReadResponseHeader(const QNetworkReply &responseHeader) {
